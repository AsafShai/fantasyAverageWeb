...
class Settings(BaseSettings):
    ...
    # Hourly nudge that keeps ADP/rankings snapshot history daily. Cheap: it only hits a
    # provider when that provider's 24h cache is due.
    adp_snapshot_scheduler_enabled: bool = Field(default=True, alias="ADP_SNAPSHOT_SCHEDULER_ENABLED")
